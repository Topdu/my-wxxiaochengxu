...
router.get('/updatedata', controllers.updatedata)
router.get('/getcreatedata', controllers.getcreatedata)
router.get('/getuserdata', controllers.getuserdata)
router.get('/messagedata', controllers.messagedata)
router.post('/sendmessage', controllers.sendmessage)
router.get('/updatealert_num', controllers.updatealert_num)
router.get('/insert_remind', controllers.insert_remind)
